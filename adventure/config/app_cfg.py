# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in web-myst.
...
from adventure.lib import app_globals, helpers
...
base_config.model = adventure.model
base_config.DBSession = adventure.model.DBSession
